...
class User(UserMixin, db.Model):
    ...
    def __repr__(self):
        return (
            ...
            "Bezoekende_p {}\tte_bezoeken_p {}".format(
                ...
                self.email,
                self.praktijk,
                self.bezoekende_praktijk,
                self.te_bezoeken_praktijk,
            )
        )
    ...
    def get_bezoekende_praktijk(self):
        ...
        bezoekende_user = User.query.filter_by(
            vorig_name_code=self.bezoekende_praktijk
        ).first()
